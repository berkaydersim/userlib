      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: ()
          {
            ...
            Fluttertoast.showToast(msg: "Taksi Çağırma İptal Edildi. Uygulamayı Yeniden Başlatın.");
              ...
              child: ListTile(
                ...
                trailing: Column(
                  ...
                  children: [
                    ...
                    Text(
                      tripDirectionDetailsInfo != null ? (tripDirectionDetailsInfo!.duration_value!/60).toStringAsFixed(0) +" dakika" : "",
                      style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          color: Colors.black54,
                          fontSize: 12
