...
class _MainScreenState extends State<MainScreen> {
  ...
  static const CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(39.101020, 39.550872),
    zoom: 14.4746,
  );
  ...
  String driverRideStatus = "Taksici Geliyor";
  ...
  updateArrivalTimeToUserPickupLocation(driverCurrentPositionLatLng) async {
    if (requestPositionInfo == true) {
      ...
      setState(() {
        driverRideStatus = "Taksici Geliyor :: " +
            (directionDetailsInfo.duration_value! / 60).toStringAsFixed(0) +
            " dakika";
      });
  ...
  updateReachingTimeToUserDropOffLocation(driverCurrentPositionLatLng) async {
    if (requestPositionInfo == true) {
      ...
      setState(() {
        driverRideStatus = "Hedefe varmak için :: " +
            (directionDetailsInfo.duration_value! / 60).toStringAsFixed(0) +
            " dakika";
      });
  ...
  searchNearestOnlineDrivers() async {
    ...
    if (onlineNearByAvailableDriversList.length == 0) {
      ...
      Fluttertoast.showToast(
          msg:
              "Çevrimiçi Taksi Yok. Bir süre sonra Tekrar Arayın, Uygulama Yeniden Başlatılıyor.");
        ...
        if (snap.snapshot.value != null) {
          ...
          FirebaseDatabase.instance
            ...
            if (eventSnapshot.snapshot.value == "idle") {
              Fluttertoast.showToast(
                  msg:
                      "Taksici isteğinizi reddetti. Lütfen başka taksici seçiniz.");

              Future.delayed(const Duration(milliseconds: 3000), () {
                Fluttertoast.showToast(msg: "Uygulamayı yeniden başlatın.");
          ...
          Fluttertoast.showToast(
              msg: "Bu taksici mevcut değil. Tekrar deneyin.");
        }
      });
    }
  }
  ...
  sendNotificationToDriverNow(String chosenDriverId) {
    ...
    FirebaseDatabase.instance
      ...
      if (snap.snapshot.value != null) {
        ...
        Fluttertoast.showToast(msg: "Lütfen başka bir taksici seçin.");
        return;
      }
    });
  }
        ...
        children: [
          ...
          Positioned(
            ...
            child: FloatingActionButton(
                ...
                child: Text('500m'),
                tooltip: '500 Metredeki Taksileri görürsünüz',
                onPressed: () {
                  setState(() {
                    alan = 0.6;
                  });
                  ...
                  Fluttertoast.showToast(
                      msg: "Görüş Mesafeniz 500m kilometre olarak ayarlandı");
                }),
          ),
          ...
          Positioned(
            ...
            child: FloatingActionButton(
                ...
                child: Text('2km'),
                tooltip: '2 Kilometredeki Taksileri görürsünüz',
                onPressed: () {
                  setState(() {
                    alan = 2.1;
                  });
                  ...
                  locateUserPosition();
                  Fluttertoast.showToast(
                      msg: "Görüş Mesafeniz 2 kilometre olarak ayarlandı");
                }),
          ),
          ...
          Positioned(
            ...
            child: FloatingActionButton(
                ...
                child: Text('20km'),
                tooltip: '20 Kilometredeki Taksileri görürsünüz',
                onPressed: () {
                  setState(() {
                    alan = 21.0;
                  });
                  ...
                  locateUserPosition();
                  Fluttertoast.showToast(
                      msg: "Görüş Mesafeniz 20 kilometre olarak ayarlandı");
                }),
          ),
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          //initializeGeoFireListener();
                          //locateUserPosition(); //yenilemek için
                          if (Provider.of<AppInfo>(context, listen: false)
                            ...
                            Fluttertoast.showToast(
                                msg: "Lütfen Gideceğiniz Yeri Seçiniz");
                          }
                        },
                  ...
                  children: [
                    ...
                    Center(
                      child: ElevatedButton.icon(
                        onPressed: () async {
                          var taktelefon = driverPhone;
                          launch('tel://$taktelefon');
                        },
                        style: ElevatedButton.styleFrom(
                          primary: Colors.green,
                        ),
  ...
  Future<void> drawPolyLineFromOriginToDestination() async {
    ...
    Marker originMarker = Marker(
      ...
      infoWindow:
          InfoWindow(title: originPosition.locationName, snippet: "Başlangıç"),
  ...
  initializeGeoFireListener() {
    ...
    Geofire.queryAtLocation(userCurrentPosition!.latitude,
            userCurrentPosition!.longitude, alan)!
        .listen((map) {
      print(map);
