...
class AssistantMethods
{
  static Future<String> searchAddressForGeographicCoOrdinates(Position position, context) async
  {
    ...
    if(requestResponse != "Konum Bulunamadı.")
    {
  ...
  static Future<DirectionDetailsInfo?> obtainOriginToDestinationDirectionDetails(LatLng origionPosition, LatLng destinationPosition) async
  {
    ...
    if(responseDirectionApi == "Konum Bulunamadı.")
    {
      return null;
    }
  ...
  static double calculateFareAmountFromOriginToDestination(DirectionDetailsInfo directionDetailsInfo)
  {
    ...
    double distanceTraveledFareAmountPerKilometer = (directionDetailsInfo.duration_value! / 0.8) * 0.095;

    //USD
    double totalFareAmount = distanceTraveledFareAmountPerKilometer;
    double localCurrencyTotalFare = totalFareAmount *1;//Tl ye çevirme eğer bunu yaparsan  return double.parse(localCurrencyTotalFare.toStringAsFixed(2));
